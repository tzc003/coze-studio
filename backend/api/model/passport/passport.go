...
type PassportWebEmailLoginPostRequest struct {
	...
	Password string `thrift:"password,7" form:"password" json:"password" query:"password"`
	Token    string `thrift:"token,8" form:"token" json:"token" query:"token"`
}
...
func (p *PassportWebEmailLoginPostRequest) GetToken() (v string) {
	return p.Token
}
...
func (p *PassportWebEmailLoginPostRequest) ReadField8(iprot thrift.TProtocol) error {
...
func (p *PassportWebEmailLoginPostRequest) writeField8(oprot thrift.TProtocol) (err error) {
